...
target_time = 10
word_list = ["Do, or do not. There is no “try”.","Love cannot be found where it doesn’t exist, nor can it be hidden where it truly does.","Oh yes, the past can hurt. But you can either run from it, or learn from it.",
"Why are you trying so hard to fit in when you were born to stand out?","Life moves pretty fast. If you don’t stop and look around once in a while, you could miss it.","You can’t live your life for other people. You’ve got to do what’s right for you, even if it hurts some people you love.","We are who we choose to be.","Don’t let anyone ever make you feel like you don’t deserve what you want.",
...
for index ,word in enumerate(word_list):
    print(index,word)
print("")
print("相手に言わせたいフレーズを数字で選択してください")
